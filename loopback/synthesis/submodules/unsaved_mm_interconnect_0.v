...
module unsaved_mm_interconnect_0 (
	...
	wire   [5:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> leds_s1_agent:cp_channel
	...
	wire  [91:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> uart_0_s1_agent:cp_data
	...
	wire  [15:0] botao_s1_agent_m0_address;                                                          // botao_s1_agent:m0_address -> botao_s1_translator:uav_address
	...
	wire  [92:0] botao_s1_agent_rf_source_data;                                                      // botao_s1_agent:rf_source_data -> botao_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] botao_s1_agent_rsp_fifo_out_data;                                                   // botao_s1_agent_rsp_fifo:out_data -> botao_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> botao_s1_agent:cp_valid
	wire  [91:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> botao_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // botao_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> botao_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> botao_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> botao_s1_agent:cp_endofpacket
	...
	wire  [91:0] uart_0_s1_agent_rp_data;                                                            // uart_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire         botao_s1_agent_rp_valid;                                                            // botao_s1_agent:rp_valid -> router_007:sink_valid
	wire  [91:0] botao_s1_agent_rp_data;                                                             // botao_s1_agent:rp_data -> router_007:sink_data
	wire         botao_s1_agent_rp_ready;                                                            // router_007:sink_ready -> botao_s1_agent:rp_ready
	wire         botao_s1_agent_rp_startofpacket;                                                    // botao_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         botao_s1_agent_rp_endofpacket;                                                      // botao_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         botao_s1_agent_rdata_fifo_src_valid;                                                // botao_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] botao_s1_agent_rdata_fifo_src_data;                                                 // botao_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         botao_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_005:in_0_ready -> botao_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> botao_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> botao_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // botao_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> botao_s1_agent:rdata_fifo_sink_error
	...
	unsaved_mm_interconnect_0_router_005 router_007 (
	...
	unsaved_mm_interconnect_0_cmd_mux_003 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	unsaved_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	unsaved_mm_interconnect_0_rsp_demux_003 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	unsaved_mm_interconnect_0_rsp_demux_003 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
